 ...
 * Description:       AI Model Preferences by okpoojagupta
 * Version:           0.0.1
 * Author:            okpoojagupta
 ...
 */
function ai_model_preferences_activate() {
 ...
 */
function ai_model_preferences_deactivate() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/deactivator.php';
	Includes\Deactivator::deactivate();
}

register_activation_hook( __FILE__, 'AI_Model_Preferences\ai_model_preferences_activate' );
register_deactivation_hook( __FILE__, 'AI_Model_Preferences\ai_model_preferences_deactivate' );
 ...
 * @since    0.0.1
 */
function ai_model_preferences_run() {
